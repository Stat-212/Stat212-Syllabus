...
We will have several quizzes (most likely through Moodle) in between exams. You will have limited time to complete these quizzes and are expected to work alone. There will also be an independent homework assignment using R around midterm. This is also meant to be completed alone and assess your progress using the statistical software.
